...
class fm_radio(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "fm_radio")
        ...
        self.channel_freq = channel_freq = 105.1e6
        ...
        self._channel_freq_range = qtgui.Range(80e6, 108e6, 0.1e6, 105.1e6, 200)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_float*1, './recorded_radio.wav', False)
